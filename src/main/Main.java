 ...
 * 
 * Options: -h Usage info -c Create full graph from movie list -s Split full
 * graph into components -d [graph] Reduce a given graph -r [graph] Run on given
 * graph -p [graph] Print a graph to graphml format
 * 
 * @author Peijin Zhang
 */
public class Main
{
   ...
   * results to a result directory in the format [component]Results.txt
   */
